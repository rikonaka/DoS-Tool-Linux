...
void usage(void)
{
    ...
    char *usage = "\n"
                  ...
                  "--random-src                          enable the random source IP address in syn flood attack (default enabled)\n"
                  "--repeat-times [time]                 specify the number of repetitions of the random source IP address in syn flood attack (default 128)\n"
                  "--src-addr [ip]                       specify the syn flood source IP address which will see by victim (default 192.168.1.2)\n"
                  "--src-port [port]                     specify the syn flood source port which will see by victim (default 9999)\n"
